...
public class PanelMisCitas extends JPanel {
    ...
    public PanelMisCitas(ControlVistas control) {
    ...
    private void initUI() {
        ...
        JLabel lblTitulo = new JLabel("MIS CITAS");
        lblTitulo.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        lblTitulo.setForeground(TEXTO);

        JPanel derPanel = new JPanel(new FlowLayout(FlowLayout.RIGHT, 10, 0));
        derPanel.setBackground(new Color(15, 15, 15));

        lblUsuario = new JLabel("Bienvenido");
        lblUsuario.setFont(new Font("Comic Sans MS", Font.PLAIN, 12));
        lblUsuario.setForeground(TEXTO_MUTED);

        JButton btnCerrar = new JButton("Cerrar Sesion");
        btnCerrar.setBackground(CARD);
        btnCerrar.setForeground(TEXTO);
        btnCerrar.setFont(new Font("Comic Sans MS", Font.BOLD, 11));
        ...
        derPanel.add(btnCerrar);

        topBar.add(lblTitulo,  BorderLayout.WEST);
        topBar.add(derPanel,   BorderLayout.EAST);
        ...
        JButton btnGestionar = new JButton("Gestionar Citas");
        btnGestionar.setBackground(BTN_ORO);
        btnGestionar.setForeground(new Color(15, 15, 15));
        btnGestionar.setFont(new Font("Comic Sans MS", Font.BOLD, 12));
        btnGestionar.setBorder(BorderFactory.createEmptyBorder(8, 22, 8, 22));
    ...
    public void cargarCitas() {
        ...
        if (sesion != null) {
            lblUsuario.setText("Bienvenido, " + sesion.getNombre());
        }
    ...
    private JPanel crearCard(CitaDTO cita) {
        ...
        switch (cita.getEstado()) {
            ...
            case CANCELADA:
                ...
                break;
            default:
                colorEstado = AMARILLO; //Pendiente
                break;
        }
        ...
        lblBarberia.setFont(new Font("Comic Sans MS", Font.BOLD, 14));
        ...
        JLabel lblPago = new JLabel(pagoTexto);
        lblPago.setFont(new Font("Comic Sans MS", Font.PLAIN, 10));
        lblPago.setForeground(BTN_ORO);
        ...
        JLabel lblPrecio = new JLabel("$" + String.format("%.2f",
                cita.getServicio().getPrecio()), SwingConstants.RIGHT);
        lblPrecio.setFont(new Font("Comic Sans MS", Font.BOLD, 15));
